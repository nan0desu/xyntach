...
?>
	...
	<?php 
$_loop3_data = (isset($this->scope["styles"]) ? $this->scope["styles"] : null);
$this->globals["loop"]['default'] = array
(
	"iteration"		=> 1,
	"last"		=> null,
	"total"		=> $this->isArray($_loop3_data) ? count($_loop3_data) : 0,
);
$_loop3_glob =& $this->globals["loop"]['default'];
if ($this->isArray($_loop3_data) === true)
{
	foreach ($_loop3_data as $tmp_key => $this->scope["-loop-"])
	{
		$_loop3_glob["last"] = (string) ($_loop3_glob["iteration"] === $_loop3_glob["total"]);
...
if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Стили<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>:<?php $_loop4_data = (isset($this->scope["styles"]) ? $this->scope["styles"] : null);$this->globals["loop"]['default'] = array("iteration"		=> 1,"last"		=> null,"total"		=> $this->isArray($_loop4_data) ? count($_loop4_data) : 0,);$_loop4_glob =& $this->globals["loop"]['default'];if ($this->isArray($_loop4_data) === true){foreach ($_loop4_data as $tmp_key => $this->scope["-loop-"]){$_loop4_glob["last"] = (string) ($_loop4_glob["iteration"] === $_loop4_glob["total"]);$_loop4_scope = $this->setScope(array("-loop-"));/* -- loop start output */?>[<a href="#" onclick="javascript:set_stylesheet(\'<?php echo Dwoo_Plugin_capitalize($this, $this->scope, false);?>\', false, true);reloadmain();" style="display: inline;" target="_self"><?php echo mb_strtoupper((string) substr($this->scope, 0, 1), $this->charset);?></a>]<?php if (! (isset($this->globals["loop"]["default"]["last"]) ? $this->globals["loop"]["default"]["last"]:null)) {?> <?php }
/* -- loop end output */$this->setScope($_loop4_scope, true);$_loop4_glob["iteration"]+=1;}}
}?>';
...
function removeframes() {
	...
	document.getElementById("removeframes").innerHTML = '<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>После перехода на доску фрейм будет убран<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>.';
...
function changelinks() { 
        var rep = "https://"; //replace 
        var find = "http://"; //find 
        var links = document.getElementsByTagName("a"); 
        for (i=0;i<links.length;i++) { 
         links[i].href.replace(find,rep); 
        } 
} 
//--></script>
<base target="main" />
...
<body>
<ul>
<b><a href="http://xynta.ch/news.php"><font size="6">Хуита.ч</font></a></b>
</ul>
<ul>
<li><a href="<?php echo KU_WEBFOLDER;?>" target="_top"><?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Главная страница<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?></a></li>
<!--><li><a onclick="javascript:changelinks();" href="">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Паранойя<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]</a></li></!-->
...
?>
	<li><a onclick="javascript:showdirs();" href="<?php echo $this->scope["files"]["1"];?>" target="_self">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Показать директории<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]</a></li>
<?php 
}
else {
?>
	<li><a onclick="javascript:hidedirs();" href="<?php echo $this->scope["files"]["0"];?>" target="_self">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Спрятать директории<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]</a></li>
<?php 
}?></!-->
<?php if ((defined("KU_MENUTYPE") ? KU_MENUTYPE : null) == 'normal') {
?>
	<li id="removeframes"><a href="#" onclick="javascript:return removeframes();" target="_self">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Убрать фрейм<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]</a></li>
<?php 
}?>
...
?>
	...
	<?php 
$_fh12_data = (isset($this->scope["boards"]) ? $this->scope["boards"] : null);
if ($this->isArray($_fh12_data) === true)
{
	foreach ($_fh12_data as $this->scope['sect'])
	{
...
?>
			<?php 
$_fh11_data = (isset($this->scope["sect"]["boards"]) ? $this->scope["sect"]["boards"]:null);
if ($this->isArray($_fh11_data) === true)
{
	foreach ($_fh11_data as $this->scope['brd'])
	{
/* -- foreach start output */
?>
