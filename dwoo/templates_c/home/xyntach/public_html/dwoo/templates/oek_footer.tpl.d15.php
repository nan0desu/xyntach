...
?><span><?php echo $this->scope["brd"]["name"];?></span>
		    <?php 
}
else {
?><a title="<?php echo $this->scope["brd"]["desc"];?>" href="<?php echo KU_BOARDSFOLDER;
echo $this->scope["brd"]["name"];?>"><?php echo $this->scope["brd"]["name"];?></a>
	     <?php 
}?>

		   
		   
	     <?php if ((isset($this->globals["foreach"]["brds"]["last"]) ? $this->globals["foreach"]["brds"]["last"]:null)) {
?>
		    <?php 
}
else {
